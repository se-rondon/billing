...
@Schema(name="InvoiceRequest", description="Model that represents an invoice")
@Data
public class InvoiceRequest {
	   
   @Schema(name="invoiceId", required=true, example="2", defaultValue="1", description="Unique Id that represents the owner of invoice")
